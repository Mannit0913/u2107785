...
wordcloudname<-wordcloud(words = top_words, freq = correlations_sorted_name[1:50], colors = "blue")
...
wordcloudamenity<-wordcloud(words = top_words_amenities, freq = correlations_sorted_amenities[1:50], colors = "blue")
...
top_words_description <- names(correlations_sorted_description[1:50])
# Create word cloud
wordclouddescription<-wordcloud(words = top_words_description, freq = correlations_sorted_description[1:50], colors = "blue")
